...
In Eukaryotes hereditary information is stored as DNA in cell nucleus. Genomic DNA is transcribed and replicated. For example, if stretched into a single thread, human DNA is around 2 meters long and must be compacted into a nucleus. Therefore, multiple levels of organization are applied, starting from DNA helix and histone proteins and ending with chromosomes and their territories in the nucleus (\colorbox{pink}{Figure \ref{genome_organization}}) \cite{misteli2020self}. Specific organization ensures proper functioning of the genome - genes can be expressed in the right place and time. Genomic DNA is constantly being approached by regulatory proteins and other small molecules. And all this must be carefully regulated to ensure appropriate cell grow, division and differentiation.    

\begin{figure}
    \centering
    \includegraphics[width=1\textwidth]{figures/genome_organization/genome_organization_V1.pdf}
    \caption[Genome organization]{blablabla}
    % {chromatin-structure icon by Pauline Franz https://twitter.com/_paulinefranz is licensed under CC-BY 4.0 Unported https://creativecommons.org/licenses/by/4.0/}
