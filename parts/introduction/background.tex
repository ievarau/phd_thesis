...
\end{figure}
    ...
    DNA structure is based on a sugar backbone that holds four types of nucleotides --- \ac{A}, \ac{T}, \ac{C} and \ac{G} ({Figure \ref{dna_structure}}).

    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth]{figures/dna/dna_structure_latest.pdf}
        \caption[DNA structure]{\textbf{DNA structure.} }
        \label{dna_structure}
    \end{figure}
